...
export function buildAgentToAgentMessageContext(params: {
  ...
  const lines = [
    ...
    "Normal teammate messaging should use plain text that starts with a teammate alias, not a tool call.",
...
export function buildAgentToAgentReplyContext(params: {
  ...
  const lines = [
    ...
    "If you need to contact a different teammate, write a normal message starting with that teammate's alias.",
